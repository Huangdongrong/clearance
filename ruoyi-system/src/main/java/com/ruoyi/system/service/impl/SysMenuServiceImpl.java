...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<SysMenu> selectMenusByUser(SysUser user) {
        ...
        return getChildPerms(nonNull(menus) ? menus : new LinkedList<>(), 0);
    }
    ...
    public Set<String> selectPermsByUserId(Long userId) {
        ...
        perms.stream().filter((perm) -> (StringUtils.isNotEmpty(perm))).forEachOrdered((perm) -> {
    ...
    public List<Ztree> roleMenuTreeData(SysRole role) {
        ...
        return nonNull(ztrees) ? ztrees : new ArrayList<>();
    }
    ...
    public List<SysMenu> getChildPerms(List<SysMenu> list, int parentId) {
        ...
        return nonNull(returnList) ? returnList : new ArrayList<>();
    }
